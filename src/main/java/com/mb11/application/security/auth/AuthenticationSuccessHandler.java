...
public class AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Autowired
    AuthenticationSuccessHandler(TokenProvider tokenProvider, MB11Properties mb11Properties,
    		HttpCookieAuthRequestRepository cookieAuthRequestRepository) {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        Optional<String> redirectUri = CookieUtils.getCookie(request, PLACE_URI_PARAM_COOKIE_NAME)
                .map(Cookie::getValue);
    ...
    private boolean isAuthorizedRedirectUri(String uri) {
        ...
        return mb11Properties.getOauth2().getAuthorizedRedirectUris()
                .stream()
